function Get-RelativeDifference {
    ...
    .EXAMPLE
    PS> Get-RelativeDifference -A -92 -B 12 -Method MaxAbs -Precision 4
    1.1304
    ...
    .EXAMPLE
    PS> Get-RelativeDifference -A 15 -B 22.3 -Method MeanAbsSum -Percent
    39.14%
    ...
    .EXAMPLE
    PS> Get-RelativeDifference -A -55 -B 60 -Method Min -Percent -Precision 5
    -209.09091%
    ...
    .EXAMPLE
    PS> Get-RelativeDifference 42 4242 MeanSum 7
    1.9607843
    ...
    >>     })
    >> }
    PS> $Results = $Data | Get-RelativeDifference -Method MeanAbsSum -Precision 15
    PS> $Results.Count
    100000
    PS> $Results[5]
    1.428571428571429
    ...
    >>     })
    >> }
    PS> $Results = $Data | Get-RelativeDifference -Method MeanSum
    ...
    PS> $Results = $Data | Get-RelativeDifference -Method MeanSum -SkipNull
    WARNING: Cannot divide by zero. A different method than "MeanSum" should be used for A=-3, B=3
    PS> $Results.Count
    4
    PS> $Results -join ', '
    ...
    [Alias('Get-PercentageDifference', 'grd', 'gpd')]
