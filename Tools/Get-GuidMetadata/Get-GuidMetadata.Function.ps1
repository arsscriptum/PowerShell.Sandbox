function Get-GuidMetadata {
    ...
    .EXAMPLE
    PS> Get-GuidMetadata -Guid '96ecce79-3dd9-4984-841a-56e12a6ded74' | Select-Object *UID

    GUID
    ----
    96ecce79-3dd9-4984-841a-56e12a6ded74

    PS> Get-UuidMetadata -Uuid '96ecce79-3dd9-4984-841a-56e12a6ded74' | Select-Object *UID
    ...
    the input. Output property name is based on the function name used alone; the -Guid/-Uuid
    ...
    >> Get-GuidMetadata | Format-Table -AutoSize
    ...
    .EXAMPLE
    PS> '0000000000-0000-0000-0000-000000000000' | Get-GuidMetadata
    ...
    .EXAMPLE
    PS> Get-GuidMetadata 306c5a03-c68c-6676-beba-2f78b549c623 -Strict
    Get-GuidMetadata: Unrecognized GUID version "6" (Parameter 'Guid')
    PS> Get-GuidMetadata 306c5a03-c68c-6676-beba-2f78b549c623
    ...
    .EXAMPLE
    PS> Get-GuidMetadata e0696a21-63fe-49ac-e312-3fd96beede31 -Strict
    ...
    PS> Get-GuidMetadata e0696a21-63fe-49ac-e312-3fd96beede31
    ...
    [Alias('ggm', 'Get-UuidMetadata', 'gum')]
...
if ($PSVersionTable.Version -lt '5.0') {
    Set-Alias -Name 'ggm' -Value Get-GuidMetadata
    Set-Alias -Name 'Get-UuidMetadata' -Value Get-GuidMetadata
    Set-Alias -Name 'gum' -Value Get-GuidMetadata
}
